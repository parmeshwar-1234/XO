...
const BeforeAfterSlider: React.FC<BeforeAfterSliderProps> = ({ beforeSrc, afterSrc, className = '' }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-foreground/90 flex items-center justify-center shadow-lg">
